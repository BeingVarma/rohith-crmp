...
export default function EditCustomerModal({ onClose, token, customer, onUpdate }) {
        ...
        <div className="relative z-50 inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="flex justify-between items-center mb-4 border-b border-gray-200 dark:border-gray-700 pb-3">
              <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Edit Customer Details</h3>
            ...
            {message && (
              <div className={`mb-4 text-sm text-center p-2 rounded ${message.includes('success') ? 'bg-green-100 text-green-700 dark:bg-green-800/30 dark:text-green-400' : 'bg-red-100 text-red-700 dark:bg-red-800/30 dark:text-red-400'}`}>
                {message}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-700 mt-5 sm:mt-6">
                <button 
                  type="submit" 
                  disabled={isLoading}
